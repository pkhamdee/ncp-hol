...
ในส่วนนี้ คุณจะได้เรียนรู้วิธีการตั้งค่าเครือข่าย เครือข่ายที่คุณสร้างในขั้นตอนต่อไปนี้จะช่วยให้ VM มีการเชื่อมต่อโดยการกำหนดเครือข่ายที่เหมาะสมให้กับการ์ดเชื่อมต่อเครือข่ายเสมือน (NIC) ของ VM แต่ละตัว

## [#](#ahv-networking-background) AHV Networking Background

Nutanix's Acropolis Hypervisor (AHV) ใช้ Open vSwitch (OVS) สำหรับการเชื่อมต่อเครือข่าย VM ทั้งหมด OVS เป็นซอฟต์แวร์สวิตช์โอเพนซอร์สที่ออกแบบมาเพื่อทำงานในสภาพแวดล้อมการจำลองเสมือนแบบหลายเซิร์ฟเวอร์ แต่ละเซิร์ฟเวอร์ AHV จะรักษาอินสแตนซ์ OVS ของตัวเอง และอินสแตนซ์ OVS ทั้งหมดจะรวมกันเป็นสวิตช์ลอจิคัลเดียว

แต่ละโหนดมักจะเชื่อมต่อกับสวิตช์ฟิสิคัลไปยัง Virtual LAN (VLAN) หลายตัว ซึ่งเปิดเผยเป็นเครือข่ายเสมือน

การกำหนดค่าเครือข่าย VM ทำผ่าน Prism (หรือ CLI/REST ตามต้องการ) ทำให้การจัดการเครือข่ายใน AHV ง่ายมาก

ด้วย AHV คุณยังสามารถตั้งค่าเซิร์ฟเวอร์ DHCP เพื่อกำหนด IP address ให้กับ VM บนเครือข่ายนั้นโดยอัตโนมัติโดยใช้บริการ IP address management (IPAM) IPAM อาจทำให้การจัดการเครือข่ายง่ายขึ้น เนื่องจากคุณไม่จำเป็นต้องตั้งค่าเซิร์ฟเวอร์ DHCP แยกต่างหากสำหรับเครือข่าย

รายละเอียดเพิ่มเติมเกี่ยวกับ AHV networking สามารถดูได้ [ที่นี่open in new window](https://www.nutanixbible.com/5a-book-of-ahv-architecture.html#networking)

### [#](#virtual-networks) Virtual Networks

-   คล้ายกับ VMware distributed port group
-   NIC เสมือนแต่ละตัวเป็นของเครือข่ายเสมือนหนึ่งตัวเท่านั้น
-   เครือข่ายเสมือนแต่ละตัวเป็นจุดกำหนดค่าร่วมสำหรับกลุ่ม vNIC
-   พอร์ตสวิตช์ฟิสิคัลต้องกำหนดค่าให้ trunk VLAN

มาดูเครือข่ายบนคลัสเตอร์กัน

1.  จากเมนูด้านข้าง เลือก **Network & Security** และในส่วนนั้นคลิก **Subnets**
...
-   Overlay Network : นี่คือ subnet แบบ IP-based overlay สำหรับ [Virtual Private Cloud (VPC)open in new window](https://portal.nutanix.com/page/documents/details?targetId=Nutanix-Flow-Virtual-Networking-Guide-v5_0_0:ear-flow-nw-vpc-pc-c.html)
...
### [#](#virtual-nics-of-vms) Virtual NICs of VMs

-   vNIC แต่ละตัวเป็นของเครือข่ายเสมือนหนึ่งตัวเท่านั้น
...
-   AHV สกัดคำขอ DHCP จาก guest บนเครือข่าย IPAM และแทรกการตอบสนอง
...
ในแบบฝึกหัดต่อไปนี้ คุณจะสร้างเครือข่ายโดยใช้ VLAN ที่ไม่ถูกต้อง ซึ่งหมายความว่าไม่มีการส่งทราฟฟิก VM นอกโฮสต์แต่ละตัว ลักษณะการทำงานนี้เป็นที่คาดหวังสำหรับวัตถุประสงค์การสาธิต/การศึกษาเท่านั้น

### [#](#create-subnet-without-ipam) Create Subnet without IPAM

มาสร้าง subnet ใหม่ใน Prism Central กัน เราจะสร้าง VLAN basic subnet สำหรับนี้ ใช้ VLAN ใดก็ได้นอกจาก 0 และไม่ต้องเปิดใช้งาน IP address management
...
คุณสามารถคลิก Advanced Configuration dropdown เพื่อดูว่าเลือก VLAN Basic Networking ซึ่งหมายความว่า subnet นี้จะถูกจัดการโดย Acropolis leader และไม่ใช่ network controller นอกจากนี้ หากนี่เป็น overlay network subnet คุณสามารถสลับสวิตช์เพื่อเปิดใช้งาน external connectivity สำหรับ VPC

![](images/network06.f8e8a7fc.png)

### [#](#create-subnet-with-ipam) Create Subnet with IPAM
...
-   **Override DHCP Server** - ไม่เลือก หากคุณต้องการใช้เซิร์ฟเวอร์ DHCP เฉพาะ คุณจะเลือกและระบุ IP address ของเซิร์ฟเวอร์นั้น
...
-   AHV มีความสามารถในการสร้าง subnet ประเภทต่างๆ รวมถึงความสามารถในการสร้าง overlay network สำหรับ VPC สำหรับการตั้งค่าเครือข่ายขั้นสูง
