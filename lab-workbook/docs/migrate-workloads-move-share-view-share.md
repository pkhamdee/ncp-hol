...
5.  ก่อนที่จะทำขั้นตอนถัดไป คุณต้อง log into ตัว desktop ของคุณโดยใช้ Remote Desktop คุณสามารถค้นหา desktop ของคุณบน Prism Central ได้ด้วย naming convention `Desktop##` และใช้ IP Address เพื่อทำ remote desktop เข้าไป
