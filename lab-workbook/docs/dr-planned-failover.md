...
!!! note
    หากคุณทำแบบฝึกหัด [Unplanned Failover with Nutanix Disaster Recovery](/dr-unplanned-failover/index.html) เสร็จแล้ว คุณสามารถข้ามไปที่ [Performing A Planned Failover](/dr-planned-failover/index.html)
