...
3.  ภายใน _Recovery_ site Prism Central ให้เลือก **\> Prism Central Settings**
...
3.  ใน drop-down _Availability Zone Type_ ให้เลือก **Physical Location** ป้อน IP, username, และ password ที่ให้ไว้สำหรับ _Recovery_ site PC จากนั้นคลิก **Connect**
...
!!! note
    ...
    2.  ภายใน SSH session ให้รันคำสั่งต่อไปนี้ คลิกไอคอนที่มุมขวาบนของหน้าต่างด้านล่างเพื่อ copy คำสั่งไปยัง clipboard ของคุณ คุณสามารถ paste ใน SSH session ของคุณได้
        ...
        ```
        sudo wget -O /usr/local/sbin/production_vm_recovery https://raw.githubusercontent.com/nutanixworkshops/hol_files/master/scripts/production_vm_recovery
...
จะต้องติดตั้ง Nutanix Guest Tools (NGT) ภายใน protected guest VMs ก่อน เพื่อใช้งาน functionality ของ guest script

1.  ภายใน _Primary_ site Prism Central ให้เปิด **\> Compute & Storage > VMs**
...
6.  เมื่อ VMs ทั้งสอง reboot เสร็จสิ้น ให้ตรวจสอบว่า VMs ทั้งสองมี CD-ROM drives ที่ว่างเปล่า และ _Installed Version_ แสดงเป็น **Latest**
...
1.  ภายใน _Primary_ site Prism Central ให้นำทางไปที่ **\> Data Protection > Protection Policies**
...
8.  ภายใน _Primary_ site Prism Central ให้เปิด **\> Compute & Storage > VMs**
...
1.  ภายใน _Primary_ site Prism Central ของคุณ ให้เปิด **\> Data Protection > Recovery Plans**
...
1.  เปิด `http://<USER##-WEBSERVER-IP-ADDRESS>` ใน browser tab ใหม่ (ตัวอย่างเช่น http://10.42.212.50)
...
4.  นำทางไปที่ **\> Data Protection > Recovery Plans**
    
5.  เลือก `User##`**\-FiestaRecovery** plan ของคุณแล้วคลิก **Actions > Failover**
    
6.  ภายใต้ **Failover Type** ให้เลือก **Unplanned Failover** จากนั้นคลิก **Failover**
    
    ![](images/2.611417b1.png)
...
9.  คลิกที่ `User##`**\-FiestaRecovery** เพื่อ monitor status ของการรัน plan เลือก **Tasks > Failover** เพื่อดูรายละเอียดทั้งหมด
    ...
    ![](images/4.491c2422.png)
    
    !!! note    
        หากคุณมีคำเตือนจากการ validation ก่อนเริ่มต้น failover เป็นเรื่องปกติที่ขั้นตอน _Validating Recovery Plan_ จะแสดงสถานะเป็น _Failed_
    
10.  เมื่อ Recovery Plan ถึง 100% ซึ่งจะใช้เวลาน้อยกว่า 5 นาที ให้คลิกที่มุมขวาบน
...
4.  เปิด **\> Compute & Storage > VMs**
    
5.  เลือก VMs ทั้งสองตัว จากนั้นคลิก **Actions > Delete** ยืนยันโดยคลิก **Delete**
    
6.  เปิด **\> Data Protection > Recovery Plans**
    
7.  เลือก `User##`**\-FiestaRecovery** plan ของคุณ จากนั้นคลิก **Actions > Failover**
    
    ![](images/2.611417b1.png)
    
8.  ภายใต้ **Failover Type** ให้เลือก **Unplanned Failover** จากนั้นคลิก **Failover**
    
    ![](images/3.6ee10b80.png)
    
9.  พิมพ์ **failover** ใน text field แล้วคลิก **Failover**
    
10.  ข้ามคำเตือนใดๆ ใน Recovery AZ (_Primary_ site) จากนั้นคลิก **Execute Anyway**
    
11.  คลิกชื่อ Recovery Plan ของคุณเพื่อ monitor สถานะของการรัน plan เลือก **Tasks > Failover** เพื่อดูรายละเอียดที่ครบถ้วน
...
12.  เมื่อ Recovery Plan ถึง 100% ซึ่งจะใช้เวลาน้อยกว่า 5 นาที ให้คลิกที่มุมขวาบน
    
13.  นำทางไปที่ **\> Compute & Storage > VMs** และสังเกต _Primary_ site IP Address ของ `User##`**\-WebServer** ของคุณ
    
14.  เปิด `http://<USER##-WEBSERVER-VM-PRIMARYSITE-IP-ADDRESS>` ใน browser tab ใหม่ จากนั้นตรวจสอบว่าการเปลี่ยนแปลงที่คุณได้ทำกับ application ของคุณนั้นปรากฏอยู่
...
[← Back: Planned Failover](dr-planned-failover.md) | [Home](dr-getting-started.md)