...
blueprint ที่ประกอบด้วย [existing machine](#existing-machine) ที่ถูกนำเข้ามาจาก provider[provider](#provider).
...
[← Back: Self Service DSL](selfservice-dsl.md) | [Home](selfservice-gettingstart.md)