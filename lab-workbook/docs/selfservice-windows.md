...
8.  คลิก **Clone from environment**. เนื่องจากคุณได้ระบุ details สำหรับ Windows VM ของคุณใน Project ก่อนหน้านี้แล้ว คุณจึงไม่ต้องป้อนข้อมูลเดิมซ้ำอีก.
    ...
    Macros ทำให้คุณสามารถเข้าถึง value ของ variables และ properties ที่กำหนดไว้บน entities ได้. Variables เหล่านี้จะเป็นแบบ user-defined หรือ system generated ก็ได้. โปรดดูในส่วน [Variables Overviewopen in new window](https://portal.nutanix.com/page/documents/details?targetId=Nutanix-Calm-Admin-Operations-Guide-v3_5_2:nuc-macros-variables-overview-c.html) ของ Self Service Administration and Operations Guide.
...
16. คลิก **Update** ทางด้านขวาของแถว _Memory (GiB)_, กรอกข้อมูลในช่องต่อไปนี้, และคลิก **Done**.
    ...
    -   **Max Value** - 6 ![](/images/update_config.3dbba9d5.png)
...
2.  คลิก **View in Applications**. คุณจะถูก redirect ไปยังหน้า application. การ deployment น่าจะใช้เวลาประมาณ 2 นาทีหรือน้อยกว่านั้น.
