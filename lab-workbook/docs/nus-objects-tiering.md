...
ในส่วนนี้ เราจะสร้าง lifecycle policy เพื่อ tier data จาก bucket ของ Nutanix Object ที่คุณสร้างใน [Objects Versioning Access Control](nus-objects-version.md) ไปยัง AWS bucket ที่คุณสร้างไว้ก่อนหน้านี้

1.  ภายใน Prism Central ให้นำทางไปที่ **>Services > Objects**
    
2.  เลือก Objects store ของคุณ
    
3.  คลิกที่ source bucket ของคุณ _your-name_\-**my-bucket** (อันที่คุณสร้างที่นี่ [here](nus-objects-buckets.md))
...
1.  เนื่องจาก source bucket ของคุณถูก populated ด้วย data แล้ว tiering จะเริ่มต้นหลังจากหนึ่งวัน
    ...
    -   สร้าง source bucket ของคุณโดยใช้ procedure ในส่วน _Create Bucket In Prism_ ใน [this section](nus-objects-version.md)
    -   Populate source bucket ของคุณด้วย objects (data) โดยใช้ procedure _Uploading Multiple Files to Buckets with Python)_ ใน [Objects CLI Scripts](nus-objects-cli.md)
...
[← Back: CLI and Scripting](nus-objects-cli.md) | [Home](nus-getting-start.md) | [Next: Multi-Protocol →](nus-objects-multi-protocol.md)