...
-   **Prerequisites:** ไม่มี เริ่มต้นที่นี่ได้เลย!
    
-   **Expected Total Lab Duration:** 100 นาที
    

## Instructions for Today

โปรดทำตามคำแนะนำของ instructor ที่อยู่หน้าห้องหรือใน remote session เพื่อเรียนรู้ข้อมูลพื้นฐาน (background) ที่สำคัญในช่วงเริ่มต้นของแต่ละส่วนหลัก คุณจะได้รับ tips ที่เป็นประโยชน์ ข้อมูลเกี่ยวกับขั้นตอนที่ต้องทำ และการประเมินเวลาสำหรับแต่ละส่วน

!!! note
    แม้ว่าคุณจะสามารถอ่านล่วงหน้าไปยังส่วนถัดไปได้หากคุณทำเสร็จก่อน แต่โปรดอย่าดำเนินการต่อเว้นแต่ instructor จะอนุญาต บางขั้นตอนอาจต้องมีการประสานงานกับ instructor หรืออาจทำได้เพียงครั้งเดียวต่อ cluster
