...
4.  Prism Central มี system categories ที่กำหนดไว้ล่วงหน้า 20 รายการ ซึ่งไม่สามารถ update หรือ delete ได้ คุณสามารถ assign ตัว entities ให้กับ system categories เหล่านี้ได้ในขณะที่สร้างหรือ update ตัว VMs และ entities อื่นๆ ![](/images/category1.0f8ae463.png)
...
10.  คุณจะเห็น policy ของคุณปรากฏอยู่ใน **Storage Policies** ![](/images/storagepolicy5.5faff320.png)
