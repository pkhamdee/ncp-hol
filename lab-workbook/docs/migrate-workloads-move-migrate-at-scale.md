...
4.  เพื่อยกตัวอย่าง scenarios เหล่านี้ เราได้สร้าง click-through demo สำหรับ lab ในส่วนนี้ คลิกที่นี่เพื่อเปิด [Move at Scale Demoopen in new window](https://nutanix.storylane.io/share/tvfi7lhuodu3?utm=holmigrate) กลับมาที่ lab guide นี้เมื่อคุณทำ demo เสร็จแล้ว
