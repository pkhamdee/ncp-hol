...
1.  คลิกที่ **Pencil icon** (ไอคอนดินสอ) ถัดจาก **Virtual Machine Operator Policy** และเปลี่ยนชื่อเป็น "Virtual Machine Operator User`##`" โดยที่ `##` คือหมายเลขที่คุณได้รับมอบหมาย นี่คือ shared cluster ดังนั้นอย่าลืมเปลี่ยนชื่อ policy
