...
1.  กลับไปยัง console session ของ **user`##`\-enduser** VM ของคุณ
...
[← Back: Quarantine a VM](flow-basic-quarantine.md) | [Home](flow-overview.md) | [Next: Application Policies →](flow-app-app-policies.md)