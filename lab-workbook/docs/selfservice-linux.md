...
13. คลิก **Add Credential**, กรอกข้อมูลในช่องต่อไปนี้, และคลิก **Done**.
    ...
    -   **Name** `ROCKY`
    -   **Username** `rocky`
    -   **Password** `nutanix/4u`![](/images/Picture10.7e26e158.png)
...
17. คลิก **Update** ด้านขวาของแถว _Memory (GiB)_, กรอกข้อมูลในช่องต่อไปนี้, และคลิก **Done**.
    ...
    -   **Update** - 1
    -   เปิดสวิตช์ **Editable**
    -   **Max Value** - 6 ![](/images/Picture11.c4432f82.png)
