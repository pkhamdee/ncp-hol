...
👀 [Guided walkthrough of capacity planning.open in new window](https://nutanix.storylane.io/share/scmtpldnvhqi) 👀

นี่คือ [linkopen in new window](https://nutanix.storylane.io/share/scmtpldnvhqi) ไปยัง guided walkthrough เพื่อสาธิตการทำงานของ feature นี้ เมื่อคุณทำ guided walk-through นี้เสร็จสิ้นแล้ว ให้กลับมาที่ lab manual
